import { Component, ComponentFactoryResolver, EventEmitter, Input, Output, QueryList, SimpleChanges, ViewChildren } from '@angular/core';
import { SortEvent, NgbSortableHeaderDirective } from './sortable.directive';
